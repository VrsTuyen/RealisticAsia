...
<head>
  ...
  <title>Travel News - Realistic Asia</title>
</head>
  ...
  <div class="main">
    <div class="travel-news">
      <div class="grid wide">
        <div class="row">
          <div class="col l-12 m-12 s-12">
            <div class="traval-news-head">
              <h2 class="h2-playfair-display-45">Travel news</h2>
            </div>
            <div class="travel-news-body">
              <div class="row">
